...
import tt.biz.pay.utils.wxsdk.WXPayConstants.SignType;
...
public class WXPay {
	...
	public Map<String, String> fillRequestData(Map<String, String> reqData) throws Exception {
		...
		String generateSignature = WXPayUtil.generateSignature(reqData, config.getKey(), this.signType);
		logger.info("加签中,签名为:" + config.getKey() + ",本地加签类型为:" + signType + ",加签后:" + generateSignature);
		reqData.put("sign", generateSignature);
		return reqData;
	}
